...
public abstract class Hilt_ExploreFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ExploreFragment() {
    super();
  }

  Hilt_ExploreFragment(int contentLayoutId) {
