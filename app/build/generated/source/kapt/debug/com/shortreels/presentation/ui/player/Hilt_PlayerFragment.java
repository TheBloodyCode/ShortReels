...
public abstract class Hilt_PlayerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PlayerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlayerFragment_GeneratedInjector) this.generatedComponent()).injectPlayerFragment(UnsafeCasts.<PlayerFragment>unsafeCast(this));
    }
  }
