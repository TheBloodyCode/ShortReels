...
public abstract class Hilt_CommentsBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CommentsBottomSheet() {
    super();
  }

  Hilt_CommentsBottomSheet(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CommentsBottomSheet_GeneratedInjector) this.generatedComponent()).injectCommentsBottomSheet(UnsafeCasts.<CommentsBottomSheet>unsafeCast(this));
    }
  }
