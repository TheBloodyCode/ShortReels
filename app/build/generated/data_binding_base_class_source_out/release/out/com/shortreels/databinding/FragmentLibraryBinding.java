...
public final class FragmentLibraryBinding implements ViewBinding {
  ...
  private FragmentLibraryBinding(@NonNull LinearLayout rootView, @NonNull TabLayout tabLayout,
  ...
  public static FragmentLibraryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLibraryBinding((LinearLayout) rootView, tabLayout, viewPager);
    }
